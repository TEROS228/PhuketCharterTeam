...
const RoutesPage = () => {
  ...
  const routes: Route[] = [
    ...
    },
    {
      ...
      duration: 'с 9:00 до 17:00',
      highlights: ['Пляж Пелай', 'Скрытая лагуна', 'Каякинг', 'Снорклинг'],
      price: 'От 40,000',
    ...
    {
      id: 8,
      name: '3 Дня. Острова Phi Phi Don Island + Racha Island',
    ...
    },
    {
      ...
      duration: '3 дня / 2 ночи',
      highlights: ['52 острова', 'Закаты', 'Умиротворение', 'Тропические леса'],
      price: 'От 130,000',
