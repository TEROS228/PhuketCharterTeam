      ...
      <div className="relative z-20 h-full flex items-center justify-center text-center text-white px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-lg md:text-xl lg:text-2xl mb-8 opacity-90 max-w-3xl mx-auto animate-fade-in-up delay-300">
              Незабываемые путешествия по Андаманскому морю с комфортом и стилем. 
              Профессиональные капитаны и роскошные катамараны для вашего идеального отдыха.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12 animate-fade-in-up delay-500">
            <button
              ...
              className="group relative px-8 py-4 bg-gradient-to-r from-orange-500 to-red-500 text-white font-semibold text-lg rounded-full shadow-2xl hover:shadow-orange-500/25 transform hover:-translate-y-1 transition-all duration-300 overflow-hidden min-w-[200px]"
            >
            ...
            <button
              ...
              className="group relative px-8 py-4 border-2 border-white/80 text-white hover:text-cyan-900 font-semibold text-lg rounded-full backdrop-blur-sm bg-white/10 hover:bg-white transform hover:-translate-y-1 transition-all duration-300 min-w-[200px]"
            >
...
{/* Scroll indicator */}
      ...
      {/* Плавающие элементы */}
      <div className="absolute top-20 left-10 w-3 h-3 bg-cyan-400 rounded-full opacity-70 animate-ping delay-1000"></div>
      <div className="absolute top-40 right-20 w-2 h-2 bg-blue-400 rounded-full opacity-60 animate-ping delay-2000"></div>
      <div className="absolute bottom-40 left-20 w-2 h-2 bg-teal-400 rounded-full opacity-50 animate-ping delay-3000"></div>
    </section>
  );
};
